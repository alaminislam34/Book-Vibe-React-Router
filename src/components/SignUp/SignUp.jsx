    ...
    return (
        <div>
            <form className="border-2 border-green-500 rounded-lg p-12 m-12 flex flex-col gap-6 justify-center items-center w-11/12 md:w-10/12 lg:w-6/12 mx-auto">
                ...
                <input className="outline-purple-500 focus:border-purple-500 border border-purple-500 py-2 px-4 rounded-lg w-full" type="text" name="" id="" placeholder="Your name" />
