          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center">
                <p className="py-1 px-2 md:py-2 md:px-3 rounded-full bg-blue-100 text-blue-500">
                  Category: {book.category}
                </p>
                <p className="text-yellow-400 bg-yellow-50 py-1 px-2 md:py-2 md:px-3 rounded-full">
                  Rating {book.rating} ⭐
                </p>
                <NavLink>
                  <button className="py-2 px-3 md:py-2.5 md:px-4 rounded-full text-white bg-[#23BE0A] font-semibold">
                    View Details
                  </button>
                </NavLink>
              </div>
